  ...
  <main class="mt-32 mx-auto max-w-7xl px-4 sm:mt-32">
    <div class="text-center">
        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-6">
            <span class="block xl:inline">nuages.io</span>
      ...
      <p class="mt-5 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-7 md:text-xl md:max-w-3xl">
        Je fournis des services de développement complets pour AWS avec .NET Core et le Front-End de votre choix (Blazor, Angular, Vue, Svelte). J'ai 20 ans d'expérience avec ASP.NET/C#/SQL Server et 7 ans de déploiement d'applications en production sur AWS. 
      </p>
      ...
      <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
        Contactez-moi si vous avez une idée de projet et que vous avez besoin de quelqu'un pour vous aider à le réaliser.
      </p>
      ...
      <div class="mt-12 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-12 md:text-xl md:max-w-3xl flex flex-col ">
        ...
        <a href="mailto:martin@nuages.io" class="hover:text-indigo-600">martin@nuages.io</a>
        <div>
